...
export default function CompaniesPage() {
  return <FeaturePage active="/companies" eyebrow="COMPANY DIRECTORY" title="Companies" description="Keep supplier and buyer details together in one place." actionLabel="Add company" actionHref="#form">
    ...
    <DataPanel title="Company list" subtitle="Search and open any company ledger" allowDelete rows={[{ title: "Shree Metals Pvt. Ltd.", subtitle: "Supplier · Contact: Rajesh Sharma", amount: "₹84,500 payable", status: "Supplier", tone: "amber" }, { title: "GreenEarth Industries", subtitle: "Buyer · Contact: Neha Patel", amount: "₹1,26,800 to receive", status: "Buyer", tone: "green" }, { title: "Mahalaxmi Traders", subtitle: "Both · Contact: Amit Shah", amount: "Clear balance", status: "Both", tone: "blue" }]} />
